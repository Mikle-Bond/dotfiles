    ...
    switch (type) {
      ...
      case 'settings':
        ...
        $('<div id="tpbc_holder_form" style="width:' + (((scrWidth / 2) / scrWidth) * 100) + '%!important;height:' + (scrHeight - 100) + 'px!important;max-height:' + (scrHeight - 100) + 'px!important;position:fixed;z-index:1002;top:50px;left:' + ((((scrWidth / 2) / 2) / scrWidth) * 100) + '%!important;background:#ffffff;-webkit-border-radius: 10px;border-radius:10px;-moz-border-radius:10px;border:10px solid #000;overflow:auto;color:#000000;">' +
          ...
          '</div>').appendTo("body");
        $("<h2/>", {
          html: "Torrent Settings <label style=\"color:red\">All Settings Are Saved Instantly!</label>",
          style: "text-align:left;margin:5px 0px;font-size:1.1em;font-weight:normal;line-height:1.5em;"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<label/>", {
          html: "Show Download Torrent Icon<br>"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<label/>", {
          html: "Show IMDB Icon <small>(Opens IMDB.com in new window)</small><br>"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<label/>", {
          html: "Show Search For Alternate Torrent Icon <small>(Search other torrent sites for this torrent)</small><br>"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<label/>", {
          html: "Show Buy On Amazon Icon<br>"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<label/>", {
          html: "Color Code Torrents Based Time Added<br>"
        }).appendTo('#tbpc_formcontents');
        $("<label/>", {
          html: "Y-Day:",
        ...
        $("<input/>", {
          type: "text",
          id: "tpbc_color_code_yday_color",
          disabled: "disabled",
          style: "margin-left:26px;width:25px;padding:2px;text-align:center; font-family:Verdana,Arial,Helvetica,sans-serif;margin-bottom:2px;background-color:" + color_code_yday + ";"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<input/>", {
          type: "text",
          id: "tpbc_color_code_today_color",
          disabled: "disabled",
          style: "margin-left:26px;width:25px;padding:2px;text-align:center; font-family:Verdana,Arial,Helvetica,sans-serif;margin-bottom:2px;background-color:" + color_code_today + ";"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<input/>", {
          type: "text",
          id: "tpbc_color_code_minutes_color",
          disabled: "disabled",
          style: "width:25px;padding:2px;text-align:center; font-family:Verdana,Arial,Helvetica,sans-serif;margin-bottom:2px;background-color:" + color_code_minutes + ";"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<label/>", {
          html: "Remove Torrents That Are Not From Trusted Uploaders (<img src=\"/static/img/vip.gif\" title=\"VIP\" >&nbsp;<img src=\"/static/img/trusted.png\" title=\"Trusted\" >&nbsp;<img src=\"/static/img/helper.png\" title=\"Helper\" >&nbsp;<img src=\"/static/img/moderator.gif\" title=\"Moderator\" >&nbsp;<img src=\"/static/img/supermod.png\" title=\"Supermod\" >&nbsp;<img src=\"/static/img/admin.gif\" title=\"Admin\" >)<br>"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<label/>", {
          html: "Remove Torrents Based On Keywords <small>(Not case sensitive, words are separated by a pipe | )</small><br>"
        }).appendTo('#tbpc_formcontents');
        $("<label/>", {
          html: "Keywords:",
          style: "margin-left:25px;margin-right:10px;"
        ...
        $("<label/>", {
          html: "Remove Too Small Torrents<br>"
        }).appendTo('#tbpc_formcontents');
        $("<label/>", {
          html: "Size:",
          style: "margin-left:25px;margin-right:10px;"
        ...
        $("<label/>", {
          html: "Remove All <b style=\"color:red\">Porn</b><br>"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<label/>", {
          html: "Remove <b style=\"color:red\">Porn</b> Based On Keywords <small>(Not case sensitive, words are separated by a pipe | )</small><br>"
        }).appendTo('#tbpc_formcontents');
        $("<label/>", {
          html: "Keywords:",
          style: "margin-left:25px;margin-right:10px;"
        ...
        $("<label/>", {
          html: "Remove \"Anonymous Download\" Links<br>"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<label/>", {
          html: "Click Cover Image Icon To Open Cover Image<br>"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<label/>", {
          html: "Click Comments Icon To Open Comments<br>"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<label/>", {
          html: "All comments will be shown on each torrent details page.<br>"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<label/>", {
          html: "Remember Downloaded <small>(This unchecked will NOT clear any history. MAY increase site loading time.)</small><br>"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<h2/>", {
          html: "Other Settings <label style=\"color:red\">All Settings Are Saved Instantly!</label>",
          style: "text-align:left;margin:5px 0px;font-size:1.1em;font-weight:normal;line-height:1.5em;"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<label/>", {
          html: "Show Button To Launch Remote Web Client Service<br>"
        }).appendTo('#tbpc_formcontents');
        $("<label/>", {
          html: "Client:",
          style: "margin-left:25px;margin-right:10px;"
        ...
        $("<label/>", {
          html: "Open Client In New Window"
        }).appendTo('#tbpc_formcontents');
        $("<br>").appendTo('#tbpc_formcontents');
        ...
        $("<label/>", {
          html: "Use DuckDuckGo As Search Replacement<br>"
        }).appendTo('#tbpc_formcontents');
        ...
        tpbc_single.addEventListener('click',
          function () {
            ...
            if (this.checked == true) setCookie('lw', 's', 999);
            else setCookie('lw', 'd', 999);
          }, false);
        document.getElementById('tbpc_formcontents').appendChild(tpbc_single);
        $("<label/>", {
          html: "Use Single Line Instead Of Double Line<br>"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<label/>", {
          html: "Try To Lightbox External Links <small>(Will not work with sites that block being embedded)</small><br>"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<label/>", {
          html: "Allow Saving of Favorite Users<br>"
        }).appendTo('#tbpc_formcontents');
        ...
        $("<label/>", {
          html: "Enable Option to Refresh Current Page Every "
        }).appendTo('#tbpc_formcontents');
...
/* Set all the variables that I will need and defaults if not used etc. */
  ...
  */
  ...
  $('.download:contains("()")').each(function () {
  ...
  $('<div />', {
    id: 'tpbc_btn_container',
    style: 'position:absolute; top:5px; right:5px; z-index:999;margin:0;padding:0;'
  }).appendTo("body");
  $('<img />', {
    name: 'tpbc_settings',
    title: 'TPBC Settings',
    src: '//i.imgur.com/aQMmcuW.png',
    style: 'cursor:pointer; float:right;'
  }).click(ShowSettings).appendTo("#tpbc_btn_container");
  ...
  if (remotetorrent == true) {
    switch (remotetorrent_client) {
      ...
      case '1':
        $('<img />', {
          id: 'torrent_client',
          title: 'Open Remote µTorrent',
          src: '//i.imgur.com/sDpDX2k.png',
        ...
        $('#torrent_client').on('click', function () {
          if (remotetorrent_client_mode == 'window') {
            GM_openInTab('https://remote.utorrent.com/srp', 'active');
      ...
      case '2':
        $('<img />', {
          id: 'torrent_client',
          title: 'Open Remote Vuze',
          src: '//i.imgur.com/0J5FPyM.png',
          style: 'cursor:pointer; float:right; margin-right:5px;'
        }).appendTo("#tpbc_btn_container");
        $('#torrent_client').on('click', function () {
          if (remotetorrent_client_mode == 'window') {
            GM_openInTab('http://remote.vuze.com/', 'active');
          } else if (remotetorrent_client_mode == 'lightbox') {
            LightboxBG();
      ...
      case '3':
        $('<img />', {
          id: 'torrent_client',
          title: 'Open Remote BitTorrent',
          src: '//i.imgur.com/jKNMk4G.png',
          style: 'cursor:pointer; float:right; margin-right:5px;'
        }).appendTo("#tpbc_btn_container");
        $('#torrent_client').on('click', function () {
          if (remotetorrent_client_mode == 'window') {
            GM_openInTab('https://remote.bittorrent.com/srp', 'active');
          } else if (remotetorrent_client_mode == 'lightbox') {
            LightboxBG();
      ...
      case '5':
        $('<img />', {
          ...
          src: '//i.imgur.com/GA9ghaR.png',
          style: 'cursor:pointer; float:right; margin-right:5px;'
        }).appendTo("#tpbc_btn_container");
        $('#torrent_client').on('click', function () {
          if (remotetorrent_client_mode == 'window') {
            GM_openInTab(transmission_url, 'active');
          } else if (remotetorrent_client_mode == 'lightbox') {
            LightboxBG();
  ...
  if (comments == true) {
    ...
    $("img[src$='icon_comment.gif']").on('click', function () {
      LightboxBG();
      if (single == false) var torrentID = $(this).parent().children('.detName').children('a:first').attr('href').split('/')[2];
      else var torrentID = $(this).parent().parent().parent().children('td:nth-child(2)').children('a:first').attr('href').split('/')[2];
  ...
  if (images == true) {
    ...
    $("img[src$='icon_image.gif']").on('click', function () {
      ...
      else var torrentURL = $(this).parent().parent().parent().children('td:nth-child(2)').children('a:first').attr('href');
      LightboxBG();
      $.ajax({
        url: torrentURL,
  ...
  $('#searchResult > tbody > tr').each(function (i) {
    ...
    if (single == false) var torrentID = torrentHTML.match(/\d+/g)[2];
    else var torrentID = torrentHTML.match(/\d+/g)[1];
    if (!torrentHTML.match(/alt="Next"|alt="Previous"/gi)) {
      /* Remove torrents based on minimum size */
      if (sizecontrol == true) {
        if (single == true) var torrentSizeHTML = torrentHTML.match(/(\d+.\d+|\d+)(&nbsp;)(GiB|MiB|KiB)/i)[0];
        else var torrentSizeHTML = torrentHTML.match(/(Size )(\d+.\d+|\d+)(&nbsp;)(GiB|MiB|KiB)/i)[0];
        var torrentSize = torrentSizeHTML.match(/\d+.\d+|\d+/)[0];
        var torrentSizeType = torrentSizeHTML.match(/GiB|MiB|KiB/i)[0];
        if (torrentSizeType == 'GiB') torrentSize *= (1024 * 1024);
        else if (torrentSizeType == 'MiB') torrentSize *= 1024;
        var calcedAllowedSize = sizecontrol_size;
        if (sizecontrol_type == 'GiB') calcedAllowedSize *= (1024 * 1024);
        else if (sizecontrol_type == 'MiB') calcedAllowedSize *= 1024;
        if (torrentSize <= calcedAllowedSize) $(this).remove();
      }
      /* Colour coding of torrents depending on when they were added */
      if (color_code == true) {
        if (torrentHTML.match(/Y-day/g)) {
          $(this).css({
            'background-color': color_code_yday
          });
        } else if (torrentHTML.match(/Today/g)) {
          $(this).css({
            'background-color': color_code_today
          });
        } else if (torrentHTML.match(/\d+&nbsp;mins&nbsp;ago|\d+&nbsp;min&nbsp;ago/g)) {
          $(this).css({
            'background-color': color_code_minutes
          });
        } else if (theme == true) {
          $(this).css({
        ...
        $(this).hover(
          function () {
            if (torrentHTML.match(/Y-day/g)) {
              if (theme == false) $(this).css({
                'background-color': increase_brightness(color_code_yday, 40)
              });
              else $(this).css({
                'background-color': increase_brightness(color_code_yday, -40)
              });
              ...
              if (theme == false) $(this).css({
                'background-color': increase_brightness(color_code_today, 40)
              });
              else $(this).css({
                'background-color': increase_brightness(color_code_today, -40)
              });
              ...
              if (theme == false) $(this).css({
                'background-color': increase_brightness(color_code_minutes, 40)
              });
              else $(this).css({
                'background-color': increase_brightness(color_code_minutes, -40)
              });
      ...
      if (imdb == true) {
        if ($(this).children('td:first').html().match(/Video/gi)) {
            ...
            function () {
              ...
              $.ajax({
                ...
                success: function (data) {
                  ...
                  if (imdb_url) GM_openInTab("http://" + imdb_url[0], 'active');
                  else {
          ...
          if (single == false) $($(this).children('td:nth-child(2)').children('div:first')).after(tpbc_imdb_icon);
          else $($(this).children('td:nth-child(4)').children('nobr')).after(tpbc_imdb_icon);
        }
      }
      ...
      if (info == true) {
        ...
        tpbc_info_icon.addEventListener('click',
          function () {
            if (single == false) var torrentURL = $(this).parent().children('.detName').children('a:first').attr('href');
            else var torrentURL = $(this).parent().parent().children('td:nth-child(2)').children('a:first').attr('href');
            LightboxBG();
            $.ajax({
              url: torrentURL,
              success: function (data) {
        ...
        if (single == false) $($(this).children('td:nth-child(2)').children('div:first')).after(tpbc_info_icon);
        else $($(this).children('td:nth-child(4)').children('nobr')).after(tpbc_info_icon);
      }
      ...
      if (amazon == true) {
        ...
        tpbc_amazon_icon.addEventListener('click',
          function () {
            if (single == false) var torrentName = $(this).parent().children('.detName').children('a:first').text().replace(filter_text_regex_keywords, '');
            else var torrentName = $(this).parent().parent().children('td:nth-child(2)').children('a').text().replace(filter_text_regex_keywords, '');
            torrentName = torrentName.replace(/\.|\-/gi, ' ');
            LightboxBG();
            Lightbox('www', 'https://www.amazon.com/s?field-keywords=' + torrentName, 'nobg');
          }, false);
        if (single == false) $($(this).children('td:nth-child(2)').children('div:first')).after(tpbc_amazon_icon);
        else $($(this).children('td:nth-child(4)').children('nobr')).after(tpbc_amazon_icon);
      }
      /* Search on eBay icon */
      if (ebay == true) {
  ...
  if ($('#detailsframe')) {
    ...
    /* Yes or no to showing all the comments*/
    if (loadallcomments == true) {
      $.ajax({
    ...
    if ($('#detailsframe')) {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          $('#comments > div > div > p').css({
            'color': '#F3F3F3'
          });
          $('#comments > div > div > p > a').css({
            'color': '#0094FF'
          });
          $('.comment > a').css({
            'color': '#0094FF'
